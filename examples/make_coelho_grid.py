...
output_dir = "/Users/k_masuda/data/specgrid_irdh_coelho%d/"%wavgrid_length
...
for i in range(1, len(d)):
    ...
    output = compute_grid_coelho(model_params, wmin_aa, wmax_aa, data_dir=data_dir, output_dir=output_dir, air_or_vac=air_or_vac, fixed_wavgrid_length=wavgrid_length)
